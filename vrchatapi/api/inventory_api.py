...
class InventoryApi(object):
    ...
    def redeem_reward(self, reward_redemption_request, **kwargs):  # noqa: E501
        """Redeem Reward  # noqa: E501

        Redeem a reward for the currently logged in user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.redeem_reward(reward_redemption_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: list[RewardRedemptionResult]
        """
        kwargs['_return_http_data_only'] = True
        return self.redeem_reward_with_http_info(reward_redemption_request, **kwargs)  # noqa: E501

    def redeem_reward_with_http_info(self, reward_redemption_request, **kwargs):  # noqa: E501
        """Redeem Reward  # noqa: E501
        ...
        >>> thread = api.redeem_reward_with_http_info(reward_redemption_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(list[RewardRedemptionResult], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method redeem_reward" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'reward_redemption_request' is set
        if self.api_client.client_side_validation and local_var_params.get('reward_redemption_request') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `reward_redemption_request` when calling `redeem_reward`")  # noqa: E501
        ...
        body_params = None
        if 'reward_redemption_request' in local_var_params:
            body_params = local_var_params['reward_redemption_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
